...
<c:if test="${CurrentUser.isBoardAdmin != 0 || CurrentUser.isForumAdmin == 1 }">
	...
	<form action="/testdb/banAndDelete">
		帖子关键词：
		<input type="text" name="searchPostByKeyWord" placeholder="search Post by key word"class="inputtable" style="padding-left;padding-right;margin-left;margin-right;width:60%" >
	...
	<div id="context1" style="background-color:white; border: 1px solid red;width:128px;display:none" ></div>
		...
		<tbody>
			...
			删除<br>
		    <input type="text" name="bdReason" placeholder="bdReason">
			<br>
